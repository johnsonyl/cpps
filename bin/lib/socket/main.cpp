...
module socket
{
	var initmimetype(var server)
	{
		...
		server.add_type("audio/x-aiff","aifc");
		server.add_type("audio/aiff","aiff");
		server.add_type("audio/x-aiff","aiff");
		...
		server.add_type("application/arj","arj");
		...
		server.add_type("video/x-ms-asf","asx");
		server.add_type("video/x-ms-asf-plugin","asx");
		server.add_type("audio/basic","au");
		server.add_type("audio/x-au","au");
		server.add_type("application/x-troff-msvideo","avi");
		server.add_type("video/avi","avi");
		server.add_type("video/msvideo","avi");
		server.add_type("video/x-msvideo","avi");
		server.add_type("video/avs-video","avs");
		server.add_type("application/x-bcpio","bcpio");
		server.add_type("application/mac-binary","bin");
		server.add_type("application/macbinary","bin");
		server.add_type("application/octet-stream","bin");
		server.add_type("application/x-binary","bin");
		server.add_type("application/x-macbinary","bin");
		server.add_type("image/bmp","bm");
		server.add_type("image/bmp","bmp");
		server.add_type("image/x-windows-bmp","bmp");
		...
		server.add_type("text/plain","c");
		server.add_type("text/x-c","c");
		server.add_type("text/plain","c++");
		server.add_type("application/vnd.ms-pki.seccat","cat");
		server.add_type("text/plain","cc");
		server.add_type("text/x-c","cc");
		server.add_type("application/clariscad","ccad");
		server.add_type("application/x-cocoa","cco");
		server.add_type("application/cdf","cdf");
		server.add_type("application/x-cdf","cdf");
		server.add_type("application/x-netcdf","cdf");
		...
		server.add_type("application/java-byte-code","class");
		server.add_type("application/x-java-class","class");
		server.add_type("application/octet-stream","com");
		server.add_type("text/plain","com");
		server.add_type("text/plain","conf");
		server.add_type("application/x-cpio","cpio");
		server.add_type("text/x-c","cpp");
		...
		server.add_type("application/pkcs-crl","crl");
		server.add_type("application/pkix-crl","crl");
		server.add_type("application/pkix-cert","crt");
		server.add_type("application/x-x509-ca-cert","crt");
		...
		server.add_type("drawing/x-dwf (old)","dwf");
		server.add_type("model/vnd.dwf","dwf");
		server.add_type("application/acad","dwg");
		server.add_type("image/vnd.dwg","dwg");
		server.add_type("image/x-dwg","dwg");
		server.add_type("application/dxf","dxf");
		server.add_type("image/vnd.dwg","dxf");
		server.add_type("image/x-dwg","dxf");
		server.add_type("application/x-director","dxr");
		server.add_type("text/x-script.elisp","el");
		server.add_type("application/x-bytecode.elisp (compiled elisp)","elc");
		...
		server.add_type("application/envoy","evy");
		...
		server.add_type("multipart/x-gzip","gzip");
		server.add_type("text/plain","h");
		server.add_type("text/x-h","h");
		...
		server.add_type("application/binhex4","hqx");
		server.add_type("application/mac-binhex","hqx");
		server.add_type("application/mac-binhex40","hqx");
		server.add_type("application/x-binhex40","hqx");
		server.add_type("application/x-mac-binhex40","hqx");
		...
		server.add_type("application/iges","iges");
		server.add_type("model/iges","iges");
		server.add_type("application/iges","igs");
		server.add_type("model/iges","igs");
		server.add_type("application/x-ima","ima");
		...
		server.add_type("application/x-lzh","lzh");
		server.add_type("application/lzx","lzx");
		server.add_type("application/octet-stream","lzx");
		server.add_type("application/x-lzx","lzx");
		server.add_type("text/plain","m");
		...
		server.add_type("application/x-magic-cap-package-1.0","mc$");
		server.add_type("application/mcad","mcd");
		server.add_type("application/x-mathcad","mcd");
		server.add_type("image/vasa","mcf");
		server.add_type("text/mcf","mcf");
		...
		server.add_type("application/x-midi","mid");
		server.add_type("audio/midi","mid");
		server.add_type("audio/x-mid","mid");
		server.add_type("audio/x-midi","mid");
		server.add_type("music/crescendo","mid");
		server.add_type("x-music/x-midi","mid");
		server.add_type("application/x-midi","midi");
		server.add_type("audio/midi","midi");
		server.add_type("audio/x-mid","midi");
		server.add_type("audio/x-midi","midi");
		server.add_type("music/crescendo","midi");
		server.add_type("x-music/x-midi","midi");
		server.add_type("application/x-frame","mif");
		server.add_type("application/x-mif","mif");
		server.add_type("message/rfc822","mime");
		...
		server.add_type("application/x-meme","mm");
		server.add_type("application/base64","mme");
		server.add_type("audio/mod","mod");
		server.add_type("audio/x-mod","mod");
		server.add_type("video/quicktime","moov");
		server.add_type("video/quicktime","mov");
		server.add_type("video/x-sgi-movie","movie");
		server.add_type("audio/mpeg","mp2");
		server.add_type("audio/x-mpeg","mp2");
		server.add_type("video/mpeg","mp2");
		server.add_type("video/x-mpeg","mp2");
		server.add_type("video/x-mpeq2a","mp2");
		server.add_type("audio/mpeg3","mp3");
		server.add_type("audio/x-mpeg-3","mp3");
		server.add_type("video/mpeg","mp3");
		server.add_type("video/x-mpeg","mp3");
		server.add_type("audio/mpeg","mpa");
		server.add_type("video/mpeg","mpa");
		server.add_type("application/x-project","mpc");
		server.add_type("video/mpeg","mpe");
		server.add_type("video/mpeg","mpeg");
		server.add_type("audio/mpeg","mpg");
		...
		server.add_type("application/x-pcl","pcl");
		...
		server.add_type("audio/make.my.funk","pfunk");
		server.add_type("image/x-portable-graymap","pgm");
		server.add_type("image/x-portable-greymap","pgm");
		...
		server.add_type("image/x-portable-anymap","pnm");
		server.add_type("application/mspowerpoint","pot");
		server.add_type("application/vnd.ms-powerpoint","pot");
		...
		server.add_type("application/vnd.ms-powerpoint","pps");
		server.add_type("application/mspowerpoint","ppt");
		server.add_type("application/powerpoint","ppt");
		server.add_type("application/vnd.ms-powerpoint","ppt");
		...
		server.add_type("audio/x-pn-realaudio","ra");
		server.add_type("audio/x-pn-realaudio-plugin","ra");
		server.add_type("audio/x-realaudio","ra");
		server.add_type("audio/x-pn-realaudio","ram");
		server.add_type("application/x-cmu-raster","ras");
		server.add_type("image/cmu-raster","ras");
		server.add_type("image/x-cmu-raster","ras");
		...
		server.add_type("application/vnd.rn-realmedia","rm");
		...
		server.add_type("audio/x-pn-realaudio-plugin","rmp");
		server.add_type("application/ringing-tones","rng");
		server.add_type("application/vnd.nokia.ringing-tone","rng");
		...
		server.add_type("audio/x-pn-realaudio-plugin","rpm");
		server.add_type("text/richtext","rt");
		server.add_type("text/vnd.rn-realtext","rt");
		server.add_type("application/rtf","rtf");
		server.add_type("application/x-rtf","rtf");
		server.add_type("text/richtext","rtf");
		server.add_type("application/rtf","rtx");
		...
		server.add_type("text/x-script.guile","scm");
		server.add_type("text/x-script.scheme","scm");
		server.add_type("video/x-scm","scm");
		server.add_type("text/plain","sdml");
		server.add_type("application/sdp","sdp");
		server.add_type("application/x-sdp","sdp");
		server.add_type("application/sounder","sdr");
		server.add_type("application/sea","sea");
		server.add_type("application/x-sea","sea");
		server.add_type("application/set","set");
		server.add_type("text/sgml","sgm");
		server.add_type("text/x-sgml","sgm");
		server.add_type("text/sgml","sgml");
		server.add_type("text/x-sgml","sgml");
		server.add_type("application/x-bsh","sh");
		server.add_type("application/x-sh","sh");
		server.add_type("application/x-shar","sh");
		server.add_type("text/x-script.sh","sh");
		server.add_type("application/x-bsh","shar");
		server.add_type("application/x-shar","shar");
		...
		server.add_type("audio/x-adpcm","snd");
		server.add_type("application/solids","sol");
		server.add_type("application/x-pkcs7-certificates","spc");
		...
		server.add_type("application/vnd.ms-pki.stl","stl");
		server.add_type("application/x-navistyle","stl");
		...
		server.add_type("image/vnd.dwg","svf");
		server.add_type("image/x-dwg","svf");
		server.add_type("application/x-world","svr");
		...
		server.add_type("application/toolbook","tbk");
		server.add_type("application/x-tbook","tbk");
		server.add_type("application/x-tcl","tcl");
		...
		server.add_type("text/uri-list","uni");
		...
		server.add_type("model/vrml","vrml");
		server.add_type("x-world/x-vrml","vrml");
		...
		server.add_type("application/wordperfect6.0","wp5");
		...
		server.add_type("application/mswrite","wri");
		server.add_type("application/x-wri","wri");
		server.add_type("application/x-world","wrl");
		server.add_type("model/vrml","wrl");
		server.add_type("x-world/x-vrml","wrl");
		server.add_type("model/vrml","wrz");
		server.add_type("x-world/x-vrml","wrz");
		...
		server.add_type("image/x-xbm","xbm");
		server.add_type("image/xbm","xbm");
		...
		server.add_type("application/x-excel","xla");
		server.add_type("application/x-msexcel","xla");
		server.add_type("application/excel","xlb");
		server.add_type("application/vnd.ms-excel","xlb");
		server.add_type("application/x-excel","xlb");
		server.add_type("application/excel","xlc");
		server.add_type("application/vnd.ms-excel","xlc");
		server.add_type("application/x-excel","xlc");
		server.add_type("application/excel","xld");
		server.add_type("application/x-excel","xld");
		server.add_type("application/excel","xlk");
		server.add_type("application/x-excel","xlk");
		server.add_type("application/excel","xll");
		server.add_type("application/vnd.ms-excel","xll");
		server.add_type("application/x-excel","xll");
		server.add_type("application/excel","xlm");
		server.add_type("application/vnd.ms-excel","xlm");
		server.add_type("application/x-excel","xlm");
		server.add_type("application/excel","xls");
		server.add_type("application/vnd.ms-excel","xls");
		server.add_type("application/x-excel","xls");
		server.add_type("application/x-msexcel","xls");
		server.add_type("application/excel","xlt");
		server.add_type("application/x-excel","xlt");
		server.add_type("application/excel","xlv");
		server.add_type("application/x-excel","xlv");
		server.add_type("application/excel","xlw");
		server.add_type("application/vnd.ms-excel","xlw");
		server.add_type("application/x-excel","xlw");
		server.add_type("application/x-msexcel","xlw");
		server.add_type("audio/xm","xm");
		server.add_type("application/xml","xml");
		server.add_type("text/xml","xml");
		server.add_type("xgl/movie","xmz");
		server.add_type("application/x-vnd.ls-xpix","xpix");
		server.add_type("image/x-xpixmap","xpm");
		...
		server.add_type("image/x-xwindowdump","xwd");
		server.add_type("chemical/x-pdb","xyz");
		server.add_type("application/x-compress","z");
		server.add_type("application/x-compressed","z");
		server.add_type("application/x-compressed","zip");
		server.add_type("application/x-zip-compressed","zip");
