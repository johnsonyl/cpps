...
namespace cpps
{
	...
	void call_function(C *c_state, cpps_value &ret, cpps_domain *domain, std::vector<cpps_value> &o, context &c, F &f, IsVoid)
	{
	...
	void call_function(C *c_state, cpps_value &ret, cpps_domain *domain, std::vector<cpps_value> &o, context &c, F &f, cpps_is_void<void>)
	{
