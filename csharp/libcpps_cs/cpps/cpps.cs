...
namespace cpps
{
	...
	{
#if WINDOWS
		public const  string libname = "cpps_interface.dll";
#elif MACOS || IOS
		public const  string libname = "cpps_interface.dylib";
#elif ANDROID
		public const  string libname = "cpps_interface.so";
#else //why not have LINUX?
		public const  string libname = "cpps_interface.so";
#endif
